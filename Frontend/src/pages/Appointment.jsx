...
function Appointment() {
  ...
  const ageField = register('age', {
    required: t('appointment.errors.ageRequired'),
    pattern: {
      value: /^[0-9]{1,2}$/,
      message: t('appointment.errors.ageInvalid'),
    },
    min: { value: 1, message: t('appointment.errors.ageMin') },
    max: { value: 99, message: t('appointment.errors.ageMax') },
    setValueAs: (v) => (v === '' || v == null ? v : Number(v)),
  });
              ...
              >
                ...
                <div>
                  ...
                  <select
                    id="gender"
                    className={fieldClass}
                    {...register('gender', { required: t('appointment.errors.genderRequired') })}
                  >
                ...
                <div>
                  ...
                  <select
                    id="disease"
                    className={fieldClass}
                    {...register('disease', { required: t('appointment.errors.diseaseRequired') })}
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    {...register('preferredDate', {
                      required: t('appointment.errors.dateRequired'),
                    })}
                  />
